...
$rabbit_addresses        = ['192.168.200.51','192.168.200.52','192.168.200.53']
$memcached_servers       = ['192.168.220.51:11211,192.168.220.52:11211,192.168.220.53:11211']
...
# Swift addresses:
$swift_proxy_address    = '192.168.200.62'
# MySQL Information
...
# Load clean-disk script to zero-out swift storage node drives
import 'clean-disk'
...
node /PRIMARY_CONTROLLER/ inherits base {
...
node /ADDL_CONTROLLERS/ inherits base {
...
node /COMPUTE_NODES/ inherits base {
  ...
  class { 'openstack::compute':
    ...
    rabbit_user        => $rabbit_user,
    rabbit_addresses    => $rabbit_addresses,
    glance_api_servers => "192.168.200.40:9292",
    api_bind_address   => $ipaddress_eth0,    
